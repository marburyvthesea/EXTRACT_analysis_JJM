...
#SBATCH -o ./logfiles/mat_to_h5_tds.%x-%j.out
#SBATCH --job-name="mat_to_h5_tds"
...
Usage:
  ...
  sbatch SLURM_quest_mat_to_h5_mov_tds.sh MAT_PATH H5_PATH [VAR_NAME] [DSET_NAME] [FRAMES_PER_CHUNK] [CAST_TO] [--downsample-input N] [--deflate-level N]
...
Notes:
  ...
  - You can still override Slurm resources at submission time, e.g.:
    sbatch -A p30771 -p short --mem=40G SLURM_quest_mat_to_h5_mov_tds.sh ...
EOF
}
