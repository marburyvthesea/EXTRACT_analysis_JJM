...
matlab -nosplash -nodesktop -r "addpath(genpath('/home/jma819/EXTRACT-public_JJM'));addpath(genpath('/home/jma819/EXTRACT_analysis_JJM'));maxNumCompThreads(str2num(getenv('SLURM_CPUS_PER_TASK')));filePath='$INPUT_pathToMotionCorrectedFile';num_partitions='$INPUT_numPartitions';savePath='$INPUT_savePath';run('runEXTRACTfromCalAliJJM_RSSCallSaveParts.m');exit;"
